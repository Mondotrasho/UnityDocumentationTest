---
title: "Class Jiggler"
sidebar_label: "Jiggler"
---
# <a id="Global_Jiggler"></a> Class Jiggler
...
### <a id="Global_Jiggler_jigPosition"></a> jigPosition

```csharp
[Header("Position Jiggler")]
public bool jigPosition
```
...
### <a id="Global_Jiggler_jigRotation"></a> jigRotation

```csharp
[Header("Rotation Jiggler")]
public bool jigRotation
```
...
### <a id="Global_Jiggler_jigScale"></a> jigScale

```csharp
[Header("Scale Jiggler")]
public bool jigScale
```
...
### <a id="Global_Jiggler_positionFrequency"></a> positionFrequency
...
### <a id="Global_Jiggler_positionJigAmount"></a> positionJigAmount
...
### <a id="Global_Jiggler_power"></a> power
...
### <a id="Global_Jiggler_rotationFrequency"></a> rotationFrequency
...
### <a id="Global_Jiggler_rotationJigAmount"></a> rotationJigAmount
...
### <a id="Global_Jiggler_scaleFrequency"></a> scaleFrequency
...
### <a id="Global_Jiggler_scaleJigAmount"></a> scaleJigAmount

```csharp
public Vector3 scaleJigAmount
```
