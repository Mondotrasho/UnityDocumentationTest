---
title: "Class PlayerLanded"
sidebar_label: "PlayerLanded"
---
# <a id="Platformer_Gameplay_PlayerLanded"></a> Class PlayerLanded
...
```csharp
public class PlayerLanded : Simulation.Event<PlayerLanded>, IComparable<Simulation.Event>
```
...
[Simulation.Event<PlayerLanded\>](Platformer.Core.Simulation.Event\-1.md) ← 
[PlayerLanded](Platformer.Gameplay.PlayerLanded.md)
...
[Simulation.Event<PlayerLanded\>.OnExecute](Platformer.Core.Simulation.Event\-1.md\#Platformer\_Core\_Simulation\_Event\_1\_OnExecute), 
...
### <a id="Platformer_Gameplay_PlayerLanded_player"></a> player
...
### <a id="Platformer_Gameplay_PlayerLanded_Execute"></a> Execute\(\)
