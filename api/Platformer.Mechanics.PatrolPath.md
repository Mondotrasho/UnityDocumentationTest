---
title: "Class PatrolPath"
sidebar_label: "PatrolPath"
---
# <a id="Platformer_Mechanics_PatrolPath"></a> Class PatrolPath
...
### <a id="Platformer_Mechanics_PatrolPath_endPosition"></a> endPosition
...
### <a id="Platformer_Mechanics_PatrolPath_startPosition"></a> startPosition
...
### <a id="Platformer_Mechanics_PatrolPath_CreateMover_System_Single_"></a> CreateMover\(float\)

Create a Mover instance which is used to move an entity along the path at a certain speed.

```csharp
public PatrolPath.Mover CreateMover(float speed = 1)
```
...
#### Returns
 ...
 [PatrolPath](Platformer.Mechanics.PatrolPath.md).[Mover](Platformer.Mechanics.PatrolPath.Mover.md)
